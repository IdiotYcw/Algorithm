...
也就是说StrictRedis类更接近原生redis，而Redis类实现的一些command会和原生redis有区别（参数会有不同）
...
# 一些时间复杂度
[PYTHON内置方法的时间复杂度](http://www.orangecube.net/python-time-complexity)  
